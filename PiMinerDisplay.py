...
class PiMinerDisplay:
	...
	def dispScreen(self, newScreen):
        ...
        #Display Hostname and temp
	def dispHost(self):
                self.dispScreen(self.info.screen6)

                #Display Hostname and temp
	def dispTemp(self):
                self.dispScreen(self.info.screen7)
	...
	def update(self):
		self.info.refresh()
                ...
                elif self.mode == 5: self.dispHost()
                elif self.mode == 6: self.dispTemp()
